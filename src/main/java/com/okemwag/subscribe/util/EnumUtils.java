...
public class EnumUtils {
  ...
  public static PaymentStatus parsePaymentStatus(String value) {
    ...
    try {
      ...
      throw new SubscribeException(
          "Invalid payment status: " + value + ". Valid values are: " + getValidPaymentStatuses());
    }
  }
  ...
  public static PaymentMethod parsePaymentMethod(String value) {
    ...
    try {
      ...
      throw new SubscribeException(
          "Invalid payment method: " + value + ". Valid values are: " + getValidPaymentMethods());
    }
  }
  ...
  public static BillingCycle parseBillingCycle(String value) {
    ...
    try {
      ...
      throw new SubscribeException(
          "Invalid billing cycle: " + value + ". Valid values are: " + getValidBillingCycles());
    }
  }
  ...
  public static InvoiceStatus parseInvoiceStatus(String value) {
    ...
    try {
      ...
      throw new SubscribeException(
          "Invalid invoice status: " + value + ". Valid values are: " + getValidInvoiceStatuses());
    }
  }
  ...
  public static String getValidPaymentStatuses() {
    return Arrays.stream(PaymentStatus.values()).map(Enum::name).collect(Collectors.joining(", "));
  }
  ...
  public static String getValidPaymentMethods() {
    return Arrays.stream(PaymentMethod.values()).map(Enum::name).collect(Collectors.joining(", "));
  }
  ...
  public static String getValidBillingCycles() {
    return Arrays.stream(BillingCycle.values()).map(Enum::name).collect(Collectors.joining(", "));
  }
  ...
  public static String getValidInvoiceStatuses() {
    return Arrays.stream(InvoiceStatus.values()).map(Enum::name).collect(Collectors.joining(", "));
  }
